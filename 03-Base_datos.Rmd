...
|:----|:---:|
|Unidades de suelos Cuenca completa - 1:500.000|[Csueccpm](BDsuelos_Caroni\3_Geoinformacion\Vectorial\1_Plan_Maestro_2004/xxxx.zip)|
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Capacidad de Uso"><img style="border: 2px solid; color: Silver; " alt="Csuebdhfao.png" src="Imagenes/cuso_cc_pm1.png" /></a>
</p>
</div>
...
|Descripcion|Nombre archivo|
|:----|:---:|
|Capacidad de uso de las tierras Cuenca completa - 1:500.000|[Cusoccpm](BDsuelos_Caroni\3_Geoinformacion\Vectorial\1_Plan_Maestro_2004/xxxx.zip)|
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Riesgo de erosion potencial"><img style="border: 2px solid; color: Silver; " alt="Csuebdhfao.png" src="Imagenes/repo_cc_pm.png" /></a>
</p>
</div>
...
|Descripcion|Nombre archivo|
|:----|:---:|
|Riesgo de erosion de los suelos Cuenca completa - 1:500.000|[Repccpm](BDsuelos_Caroni\3_Geoinformacion\Vectorial\1_Plan_Maestro_2004/xxxx.zip)|
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Contenido de arena"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/5_arena.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Contenido de limo"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/6_Limo.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Contenido de arcilla"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/4_Arcilla.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Fragmento grueso"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/7_Fragmento.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Densidad aparente"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/3_Da.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Capacidad de campo"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/8_VWC33.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Punto de marchitez permanente"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/9_VWC1500.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="pH"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/14_ph_sg.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="pH"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/15_ph_vsfao.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Carbono organico"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/16_cos_sg.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Carbono organico"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/17_cos_vsfao.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Densidad de COS"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/13_Dcos.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Stock de COS"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/12_Scos.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Capacidad de intercambio cationico"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/10_cic.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Nitrogeno total"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/11_Nit.png" /></a>
</p>
</div>
...
Capa de conductividad electrica en dS/m de los suelos para toda la cuenca en una capa de tipo raster con una resolucion espacial de 950 m, desarrollada para dos capas superficiales de suelos ( 0 a 30 cm y 30 a 100 cm) por **Victor Sevilla y FAO**.

<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Conductividad electrica"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/18_ce.png" /></a>
</p>
</div>
...
<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="Imagenes/Csuebdhfao.png" target="_blank" title="Sitios de muestreo"><img style="border: 2px solid; color: Black; " alt="Csuebdhfao.png" src="Imagenes/19_perfil_sg.png" /></a>
</p>
</div>
...
> Para descargar una tabla con la **lista de las capas** de georinformacion recolectadas y su respectiva **Metadata**, y ademas del **banco de informacion edafica** (directorio completo), haga clic en las figuras mostradas a continuacion.


<div>
<p style = 'text-align:center;'>
<a style = 'padding-right: 40px;' href="BDsuelos_Caroni\3_Geoinformacion\Tablas/Lista_Capas_Metadata.xlsx" target="_blank" title="Lista de Capas y Metadatos"><img src="Imagenes/estadisticas1.png" alt="Lista de Capas y Metadatos" width="126" height="107"/></a>
<a style = 'padding-right: 40px;' href="Zip/BDsuelos_Caroni.zip" target="_blank" title="Banco de informacion sobre suelos"><img src="Imagenes/directorio12.png" alt="Banco de informacion sobre suelos" width="126" height="107"/></a>
</p>
</div>
