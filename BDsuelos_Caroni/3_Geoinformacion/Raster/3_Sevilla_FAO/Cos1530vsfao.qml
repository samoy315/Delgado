...
<qgis maxScale="0" styleCategories="AllStyleCategories" version="3.28.15-Firenze" minScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" type="singlebandpseudocolor" opacity="1" nodataColor="" band="1" classificationMin="1" classificationMax="47">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader maximumValue="47" colorRampType="INTERPOLATED" clip="0" minimumValue="1" classificationMode="3" labelPrecision="0">
          ...
          <item label="7" color="#ffeeb5" alpha="255" value="7"/>
          <item label="8" color="#fedd96" alpha="255" value="8"/>
          <item label="8" color="#fec46c" alpha="255" value="8"/>
          <item label="8" color="#fea73f" alpha="255" value="8"/>
          <item label="8" color="#f68c23" alpha="255" value="8"/>
          <item label="9" color="#e57217" alpha="255" value="9"/>
          <item label="10" color="#d25a0d" alpha="255" value="10"/>
          <item label="11" color="#b54708" alpha="255" value="11"/>
          <item label="47" color="#993404" alpha="255" value="47"/>
