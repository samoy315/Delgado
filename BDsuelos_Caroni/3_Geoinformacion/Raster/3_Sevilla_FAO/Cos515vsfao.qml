...
<qgis maxScale="0" styleCategories="AllStyleCategories" version="3.28.15-Firenze" minScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" type="singlebandpseudocolor" opacity="1" nodataColor="" band="1" classificationMin="1" classificationMax="68">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader maximumValue="68" colorRampType="INTERPOLATED" clip="0" minimumValue="1" classificationMode="3" labelPrecision="0">
          ...
          <item label="10" color="#fed98e" alpha="255" value="10"/>
          <item label="12" color="#fe9929" alpha="255" value="12"/>
          <item label="14" color="#d95f0e" alpha="255" value="14"/>
          <item label="68" color="#993404" alpha="255" value="68"/>
