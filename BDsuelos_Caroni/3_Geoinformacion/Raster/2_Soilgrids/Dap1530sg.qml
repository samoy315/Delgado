...
<qgis hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.28.15-Firenze" styleCategories="AllStyleCategories" maxScale="0">
  <flags>
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" classificationMin="82" classificationMax="151" alphaBand="-1" band="1" opacity="1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader labelPrecision="4" clip="0" colorRampType="INTERPOLATED" maximumValue="151" classificationMode="3" minimumValue="82">
    ...
    <huesaturation colorizeStrength="100" invertColors="0" colorizeBlue="128" colorizeGreen="128" grayscaleMode="0" saturation="0" colorizeRed="255" colorizeOn="0"/>
