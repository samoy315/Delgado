...
<qgis hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.28.15-Firenze" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" band="1" classificationMin="95" classificationMax="971" type="singlebandpseudocolor" nodataColor="" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader classificationMode="3" clip="0" minimumValue="95" maximumValue="971" colorRampType="INTERPOLATED" labelPrecision="4">
          ...
          <item value="88" color="#ffffd4" alpha="255" label="88.0000"/>
          <item value="250.99974193114724" color="#fed98e" alpha="255" label="250.9997"/>
          <item value="292.9998787676552" color="#fe9929" alpha="255" label="292.9999"/>
          <item value="349.00006121633254" color="#d95f0e" alpha="255" label="349.0001"/>
          <item value="1149.999575086633" color="#993404" alpha="255" label="1149.9996"/>
