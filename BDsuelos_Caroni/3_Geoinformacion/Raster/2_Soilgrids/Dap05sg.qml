...
<qgis hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.28.15-Firenze" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" classificationMin="40" classificationMax="145" alphaBand="-1" band="1" opacity="1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader labelPrecision="4" clip="0" colorRampType="INTERPOLATED" maximumValue="145" classificationMode="3" minimumValue="40">
          ...
          <item alpha="255" value="0" color="#30123b" label="0.0000"/>
          <item alpha="255" value="107.99996078953865" color="#28bceb" label="108.0000"/>
          <item alpha="255" value="110.99995158708343" color="#a4fc3c" label="111.0000"/>
          <item alpha="255" value="113.99994238462823" color="#fb7e21" label="113.9999"/>
          <item alpha="255" value="145.99994158441473" color="#7a0403" label="145.9999"/>
