...
<qgis minScale="1e+08" maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.28.15-Firenze" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="398" type="singlebandpseudocolor" nodataColor="" classificationMin="0" opacity="1" alphaBand="-1" band="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader clip="0" minimumValue="0" classificationMode="3" colorRampType="INTERPOLATED" maximumValue="398" labelPrecision="4">
          ...
          <item color="#c8dcf0" label="295.9999" value="295.9999039743804" alpha="255"/>
          <item color="#73b2d8" label="325.9998" value="325.9998247532442" alpha="255"/>
          <item color="#2979b9" label="347.9998" value="347.99983195516563" alpha="255"/>
          <item color="#08306b" label="407.9998" value="407.99983675644665" alpha="255"/>
