...
<qgis minScale="1e+08" maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.28.15-Firenze" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="240" type="singlebandpseudocolor" nodataColor="" classificationMin="0" opacity="1" alphaBand="-1" band="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader clip="0" minimumValue="0" classificationMode="3" colorRampType="INTERPOLATED" maximumValue="240" labelPrecision="4">
          ...
          <item color="#c8dcf0" label="185.9999" value="185.999936383027" alpha="255"/>
          <item color="#73b2d8" label="198.9999" value="198.9999099759816" alpha="255"/>
          <item color="#2979b9" label="207.9999" value="207.99987636701474" alpha="255"/>
          <item color="#08306b" label="248.9999" value="248.99990037341965" alpha="255"/>
