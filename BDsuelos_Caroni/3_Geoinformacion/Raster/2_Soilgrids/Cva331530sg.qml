...
<qgis minScale="1e+08" maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.28.15-Firenze" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="410" type="singlebandpseudocolor" nodataColor="" classificationMin="0" opacity="1" alphaBand="-1" band="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader clip="0" minimumValue="0" classificationMode="3" colorRampType="INTERPOLATED" maximumValue="410" labelPrecision="4">
          ...
          <item color="#c8dcf0" label="291.9999" value="291.99985196050307" alpha="255"/>
          <item color="#73b2d8" label="324.9999" value="324.9999223792908" alpha="255"/>
          <item color="#2979b9" label="346.9999" value="346.9998591624245" alpha="255"/>
          <item color="#08306b" label="412.9998" value="412.99983475591284" alpha="255"/>
