...
<qgis hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.28.15-Firenze" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" band="1" classificationMin="66" classificationMax="741" type="singlebandpseudocolor" nodataColor="" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader classificationMode="3" clip="0" minimumValue="66" maximumValue="741" colorRampType="INTERPOLATED" labelPrecision="4">
          ...
          <item value="56" color="#ffffd4" alpha="255" label="56.0000"/>
          <item value="149.99990872559312" color="#fed98e" alpha="255" label="149.9999"/>
          <item value="183.0000696567842" color="#fe9929" alpha="255" label="183.0001"/>
          <item value="225.00001681370654" color="#d95f0e" alpha="255" label="225.0000"/>
          <item value="763.999716568947" color="#993404" alpha="255" label="763.9997"/>
