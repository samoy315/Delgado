...
<qgis hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.28.15-Firenze" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" classificationMin="8" classificationMax="211" alphaBand="-1" band="1" opacity="1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader labelPrecision="4" clip="0" colorRampType="INTERPOLATED" maximumValue="211" classificationMode="3" minimumValue="8">
          ...
          <item alpha="255" value="5" color="#fde725" label="5.0000"/>
          <item alpha="255" value="72.0000156041632" color="#5dc963" label="72.0000"/>
          <item alpha="255" value="86.00001080288222" color="#21908d" label="86.0000"/>
          <item alpha="255" value="100.99999279807854" color="#3b528b" label="101.0000"/>
          <item alpha="255" value="229.9999099759816" color="#440154" label="229.9999"/>
