...
<qgis minScale="1e+08" maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.28.15-Firenze" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="244" type="singlebandpseudocolor" nodataColor="" classificationMin="0" opacity="1" alphaBand="-1" band="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader clip="0" minimumValue="0" classificationMode="3" colorRampType="INTERPOLATED" maximumValue="244" labelPrecision="4">
          ...
          <item color="#c8dcf0" label="180.9999" value="180.99990077352638" alpha="255"/>
          <item color="#73b2d8" label="194.9999" value="194.99989797277914" alpha="255"/>
          <item color="#2979b9" label="205.9999" value="205.99990277406013" alpha="255"/>
          <item color="#08306b" label="244.9999" value="244.99990197384665" alpha="255"/>
