...
<qgis hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.28.15-Firenze" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" classificationMin="80" classificationMax="148" alphaBand="-1" band="1" opacity="1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader labelPrecision="4" clip="0" colorRampType="INTERPOLATED" maximumValue="148" classificationMode="3" minimumValue="80">
          ...
          <item alpha="255" value="80" color="#30123b" label="80.0000"/>
          <item alpha="255" value="110.99997998006015" color="#28bceb" label="111.0000"/>
          <item alpha="255" value="114" color="#a4fc3c" label="114.0000"/>
          <item alpha="255" value="117.99999039042888" color="#fb7e21" label="118.0000"/>
          <item alpha="255" value="147.9999727728818" color="#7a0403" label="148.0000"/>
