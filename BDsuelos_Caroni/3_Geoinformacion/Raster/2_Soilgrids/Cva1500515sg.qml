...
<qgis minScale="1e+08" maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.28.15-Firenze" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="247" type="singlebandpseudocolor" nodataColor="" classificationMin="0" opacity="1" alphaBand="-1" band="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader clip="0" minimumValue="0" classificationMode="3" colorRampType="INTERPOLATED" maximumValue="247" labelPrecision="4">
          ...
          <item color="#c8dcf0" label="180.9999" value="180.99989797277914" alpha="255"/>
          <item color="#73b2d8" label="193.9999" value="193.99991357694233" alpha="255"/>
          <item color="#2979b9" label="204.0000" value="203.99995598825768" alpha="255"/>
          <item color="#08306b" label="246.9999" value="246.99990117363313" alpha="255"/>
