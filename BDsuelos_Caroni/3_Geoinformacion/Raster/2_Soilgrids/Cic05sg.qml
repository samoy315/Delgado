...
<qgis hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.28.15-Firenze" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" classificationMin="101" classificationMax="285" alphaBand="-1" band="1" opacity="1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader labelPrecision="4" clip="0" colorRampType="INTERPOLATED" maximumValue="285" classificationMode="3" minimumValue="101">
          ...
          <item alpha="255" value="74" color="#30123b" label="74.0000"/>
          <item alpha="255" value="158.9999715716854" color="#28bceb" label="159.0000"/>
          <item alpha="255" value="174.99995395413833" color="#a4fc3c" label="175.0000"/>
          <item alpha="255" value="192.99997757766735" color="#fb7e21" label="193.0000"/>
          <item alpha="255" value="290.999913113461" color="#7a0403" label="290.9999"/>
