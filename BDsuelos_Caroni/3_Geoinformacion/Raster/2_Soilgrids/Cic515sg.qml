...
<qgis hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.28.15-Firenze" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" classificationMin="75" classificationMax="268" alphaBand="-1" band="1" opacity="1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader labelPrecision="4" clip="0" colorRampType="INTERPOLATED" maximumValue="268" classificationMode="3" minimumValue="75">
          ...
          <item alpha="255" value="41" color="#30123b" label="41.0000"/>
          <item alpha="255" value="127.99995638836441" color="#28bceb" label="128.0000"/>
          <item alpha="255" value="143.999998399573" color="#a4fc3c" label="144.0000"/>
          <item alpha="255" value="162.9999027740601" color="#fb7e21" label="162.9999"/>
          <item alpha="255" value="293.99989877299265" color="#7a0403" label="293.9999"/>
